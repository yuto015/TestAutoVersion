...
echo   'FIRST=$(head -1 "$MSG_FILE")',                                       >> "%PS%"
echo   'tail -n +2 "$MSG_FILE" ^> "$MSG_FILE.tmp"',                          >> "%PS%"
echo   'echo "[v$VERSION] $FIRST" ^> "$MSG_FILE"',                           >> "%PS%"
echo   'cat "$MSG_FILE.tmp" ^>^> "$MSG_FILE"',                               >> "%PS%"
echo   'rm "$MSG_FILE.tmp"', ''                                              >> "%PS%"
echo )                                                                       >> "%PS%"
